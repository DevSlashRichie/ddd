...
class AResponse extends OperationResult_1.OperationResult {
     ...
     * @param networkCode
     */
    static failWithMessage(error, internalCode, networkCode) {
        return new AResponse(null, new DError_1.DError(error, internalCode, networkCode));
    }
}
